			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnRegistrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
		               ...
		               if(index!=0 && !txtNombre.getText().equalsIgnoreCase("") && !txtCedula.getText().equalsIgnoreCase("___-_______-_") && !txtTelefono.getText().equalsIgnoreCase("(___) ___-____") && !txtDireccion.getText().equalsIgnoreCase("") && !txtSueldo.getText().equalsIgnoreCase("") && !txtPass.getText().equalsIgnoreCase("")){
